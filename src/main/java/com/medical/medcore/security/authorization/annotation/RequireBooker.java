...
@PreAuthorize(
        "hasAnyAuthority(" +
                ...
                "T(com.medical.medcore.security.authorization.constants.RoleConstants).DOCTOR, " +
                ...
                "T(com.medical.medcore.security.authorization.constants.RoleConstants).PATIENT)"
)
public @interface RequireBooker {
}
